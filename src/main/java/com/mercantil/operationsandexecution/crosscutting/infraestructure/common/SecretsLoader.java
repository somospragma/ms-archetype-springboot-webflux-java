package com.mercantil.operationsandexecution.crosscutting.infraestructure.common;
...
public class SecretsLoader {
    ...
    private final static String SQL_ENV_NAME = "${azure.keyvault.secrets.sqlsecretsname}";
    private final static String REST_ENV_NAME = "${azure.keyvault.secrets.consumersecret}";
