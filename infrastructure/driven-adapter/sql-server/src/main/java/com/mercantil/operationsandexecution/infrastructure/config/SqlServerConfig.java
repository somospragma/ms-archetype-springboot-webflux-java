...
import com.mercantil.operationsandexecution.infrastructure.LoanRepository;
import com.mercantil.operationsandexecution.infrastructure.SaveLoanImplementation;
...
@Configuration
@EnableR2dbcRepositories(basePackages = "com.mercantil.operationsandexecution")
public class SqlServerConfig {
    ...
    @Bean
    public SaveLoanPersistence saveLoanPersistence(LoanRepository loanRepository) {
        return new SaveLoanImplementation(loanRepository);
    }
}
